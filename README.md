...
* It would a great idea to implement and use __GPT-2__ for extracting the text embeddings in the future before scoring the essays as this is leading to good performance. 
